                            ...
                            <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header no-bd">
                                                <h5 class="modal-title">
                                                    <span class="fw-mediumbold">Yeni Sayfa Ekle</span>
                                                </h5>
                                ...
                                <div class="table-responsive">
                                    <table id="add-row" class="display table table-striped table-hover text-center">
                                        ...
                                        <tbody id="sortable"
                                               data-url="<?php echo base_url("pages/ranksetter"); ?>">
                                        ...
                                        <?php if ($pages) {
                                            ...
                                            foreach ($pages as $page) { ?>
                                                    ...
                                                    <td>
                                                        <label class="switch">
                                                            <input id="isActive" type="checkbox"
                                                                ...
                                                                <?php echo ($page->Status == 1) ? "checked" : ""; ?>>
                                                ...
                                                <div class="modal fade"
                                                     id="updateRowModal<?php echo $page->ID; ?>"
                                                     tabindex="-1" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header no-bd">
                                                                <h5 class="modal-title">
                                                                    <span class="fw-mediumbold">Sayfa Güncelleme</span>
                                                                </h5>
                                                                <button type="button" class="close" data-dismiss="modal"
                                                                        aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group form-group-default">
                                                                                ...
                                                                                <i class="<?php echo $page->Icon; ?> fa-2x"></i>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                            <small>Icon seçmek
                                                                            ...
                                                                            <div class="form-group form-group-default">
                                                                                ...
                                                                                <input id="addName" type="text"
                                                                                       class="form-control"
                                                                                       name="Icon" value="<?php echo $page->Icon; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group form-group-default">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group form-group-default">
                                                                                ...
                                                                                <textarea id="addPosition"
                                                                                          class="ckeditor"
                                                                                          name="Content"><?php echo $page->Content; ?></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer no-bd">
                                            ...
                                            <tr>
                                                <td colspan="7">Herhangi bir sayfa eklenmemiştir.</td>
                                            </tr>
