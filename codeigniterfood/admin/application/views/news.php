                            ...
                            <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header no-bd">
                                                <h5 class="modal-title">
                                                    <span class="fw-mediumbold">Yeni Haber
                                                        Ekle</span>
                                                </h5>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="alert alert-info">
                                                                ...
                                                                koymayı unutmayınız.
                                                                <br>
                                                                <b>Örnek: </b>haberler, seo, gazete, kağıt
                                                            </div>
                                                            <div class="form-group form-group-default">
                                                                <label>Seo Etiketler</label>
                                                                <input id="addOffice" type="text" class="form-control"
                                                                       name="Seo_Tags" placeholder="Seo Etiketler">
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="add-row" class="display table table-striped table-hover text-center">
                                        ...
                                        <tbody id="sortable"
                                               data-url="<?php echo base_url("news/ranksetter"); ?>">
                                        ...
                                        <?php if ($news) {
                                            ...
                                            foreach ($news as $new) { ?>
                                                ...
                                                <tr id="rank-<?php echo $new->ID; ?>">
                                                    ...
                                                    <td><img class="rounded" width="100"
                                                             src="uploads/news/<?php echo $new->Image; ?>" alt="">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            ...
                                                            <a href="news/delete/<?php echo $new->ID; ?>"
                                                ...
                                                <div class="modal fade" id="updateRowModal<?php echo $new->ID; ?>"
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header no-bd">
                                                                <h5 class="modal-title">
                                                                    <span class="fw-mediumbold">Haber Güncelleme</span>
                                                                </h5>
                                                                <button type="button" class="close" data-dismiss="modal"
                                                                        aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group form-group-default">
                                                                                ...
                                                                                <img class="rounded" width="100%"
                                                                                     src="uploads/news/<?php echo $new->Image; ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group form-group-default">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group form-group-default">
                                                                                ...
                                                                                <textarea id="addPosition"
                                                                                          class="ckeditor"
                                                                                          name="Content"><?php echo $new->Content; ?></textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="form-group form-group-default">
                                            ...
                                            <tr>
                                                <td colspan="7">Herhangi bir haber eklenmemiştir.</td>
                                            </tr>
