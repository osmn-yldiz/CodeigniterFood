                            ...
                            <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header no-bd">
                                                <h5 class="modal-title">
                                                    <span class="fw-mediumbold">Yeni Referans
                                                        Ekle</span>
                                                </h5>
                                                ...
                                                <form action="brands/insert" method="POST"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group form-group-default">
                                                                <label>Link</label>
                                                                <input id="addOffice" type="url" class="form-control"
                                ...
                                <div class="table-responsive">
                                    <table id="add-row" class="display table table-striped table-hover text-center">
                                        ...
                                        <tbody id="sortable"
                                            data-url="<?php echo base_url("brands/ranksetter"); ?>">
                                            ...
                                            <tr id="rank-<?php echo $brand->ID; ?>">
                                                ...
                                                <td><img class="rounded" width="100"
                                                        src="uploads/brands/<?php echo $brand->Image; ?>" alt=""></td>
                                                ...
                                                <td>
                                                    <label class="switch">
                                                        <input id="isActive" type="checkbox"
                                                            ...
                                                            <?php echo ($brand->Status == 1) ? "checked" : ""; ?>>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <a href="brands/delete/<?php echo $brand->ID; ?>"
                                            ...
                                            <div class="modal fade" id="updateRowModal<?php echo $brand->ID; ?>"
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header no-bd">
                                                            <h5 class="modal-title">
                                                                <span class="fw-mediumbold">Referans Güncelleme</span>
                                                            </h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            ...
                                                                            <img class="rounded" width="100%" src="uploads/brands/<?php echo $brand->Image; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                            ...
                                            <tr>
                                                <td colspan="7">Herhangi bir referans eklenmemiştir.</td>
                                            </tr>
