                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="add-row" class="display table table-striped table-hover text-center">
                                        ...
                                        <tbody id="sortable"
                                            data-url="<?php echo base_url("projects/ranksetter"); ?>">
                                            ...
                                            <tr id="rank-<?php echo $project->ID; ?>">
                                                ...
                                                <td><img class="rounded" width="100"
                                                        src="uploads/projects/<?php echo $project->Image; ?>" alt=""></td>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <a href="projects/delete/<?php echo $project->ID; ?>"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            ...
                                                                            <img class="rounded" width="100%" src="uploads/projects/<?php echo $project->Image; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
