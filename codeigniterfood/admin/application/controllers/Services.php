...
class Services extends CI_Controller {
	...
	public function insert()
	{
		...
		{
			$insert = $this->default_model->insert("services",
				array(
					"Title" => $Title,
					"Icon" => $Icon,
					"Content" => $Content,
	...
	public function update($ID)
	{
		...
		{
			$update = $this->default_model->update("services",
				array(
					"ID" => $ID
				),
				array(
	...
	public function delete($ID)
	{
		...
		$delete = $this->default_model->delete("services",
			array(
				"ID" => $ID
			));
	...
	public function isactivesetter($ID) 
	{
		if($ID)
		{
			...
			$this->default_model->update("services",
			array(
				"ID" => $ID
			), 
			array(
